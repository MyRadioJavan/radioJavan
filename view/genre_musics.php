...
// ?>
    ...
    <div class="container ">
        <h2 class="text-light mt-3" >Musics of <?php echo $genres["name"];  ?> Genre</h2>
        <hr class="text-light">
        </div>
...
<?php if($musics->num_rows==0):?>
    <div class="alert alert-dark " role="alert" style="text-align: center">
        <b>There are currently no music from this Genre</b>
    </div>
<?php else:?>
    ...
    <?php endforeach; ?>
        ...
        <div class="col-12 col-sm-7 col-lg-8 d-block justify-content-center " style="text-align: center" >
          ...
          <img  id="music_image" src="<?php echo $genres["image"];?>" class="rounded mx-auto d-block rounded-4" alt="..." style="width: 400px;height: 400px">
           <h3 class="text-light mt-3" id="albumName"><?php echo $genres["name"]; ?> Genre</h3>
